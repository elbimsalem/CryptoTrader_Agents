#!/usr/bin/env python3
"""
Test Mode Runner for Extended Autonomous Crypto Trading Simulation
Easy-to-use interface for running portfolio simulation tests
"""
import sys
import os
...
def main():
    print("🤖 Autonomous Crypto Trading - Test Mode Simulation")
    print("=" * 60)
